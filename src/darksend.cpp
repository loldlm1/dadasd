...
{
    if(fLiteMode) return; // ignore all Arepa related functionality
...
/*
    ...
    allow endless transaction that would bloat Arepa and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("arepa-privatesend");
