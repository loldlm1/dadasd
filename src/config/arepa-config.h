/* src/config/arepa-config.h.  Generated from arepa-config.h.in by configure.  */
/* src/config/arepa-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef AREPA_CONFIG_H

#define AREPA_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/ArepaCoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Arepa Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Arepa Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "arepacore"
