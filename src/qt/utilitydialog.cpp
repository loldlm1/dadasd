    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Arepa Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Arepa Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  arepa-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Arepa in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 AREPA, 0.1 AREPA, 1 AREPA and 10 AREPA -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://arepapay.atlassian.net/wiki/display/DOC/PrivateSend\">https://arepapay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Arepa Core is shutting down...") + "<br /><br />" +
