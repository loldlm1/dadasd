    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("AREPA-light"), QVariant("light"));
    ui->theme->addItem(QString("AREPA-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("AREPA-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("AREPA-traditional"), QVariant("trad"));
