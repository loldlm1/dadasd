    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Arepa Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Arepa address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and arepa: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Arepa Core"), this);
    aboutAction->setStatusTip(tr("Show information about Arepa Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Arepa Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Arepa addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Arepa addresses"));
    ...
    openAction->setStatusTip(tr("Open a arepa: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Arepa Core help message to get a list with possible Arepa Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Arepa Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Arepa network", "", count));
}
...
{
    QString strTitle = tr("Arepa Core"); // default title
