 ...
 *
 *   // network
 *   CArepaNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.arepa.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CArepaNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: ArepaNetwork
// //   -- signature requirements : Key1(User)
// class CArepaNetworkVariable : public CGovernanceObject
// {
// private:
