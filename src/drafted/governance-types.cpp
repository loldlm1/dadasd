...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ArepaNetwork") type = ArepaNetwork;
    if(strType == "ArepaNetworkVariable") type = ArepaNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ArepaNetwork) s = "ArepaNetwork";
    if(type == ArepaNetworkVariable) s = "ArepaNetworkVariable";
