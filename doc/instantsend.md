...
This mechanism has been integrated into Bitcore-Node-Arepa which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/arepapay/insight-api-arepa#web-socket-api](https://github.com/arepapay/insight-api-arepa#web-socket-api) 
* API: [https://github.com/arepapay/insight-api-arepa#instantsend-transactions](https://github.com/arepapay/insight-api-arepa#instantsend-transactions) 
...
By default, the Arepa Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Arepa Core daemon:
