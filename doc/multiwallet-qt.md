...
Only requiring some minor changes is arepa.cpp.
...
Changes to arepa.cpp
----------------------
arepa.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
